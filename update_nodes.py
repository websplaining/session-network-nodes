...
VENDORS = [
    ...
    ("bradler & krantz", "Bradler & Krantz GmbH & Co. KG"),
    ("the infrastructure group", "Liteserver"), ("liteserver", "Liteserver"),
    ("fiberxpress", "FiberXpress BV"), ("uk dedicated servers", "UK Dedicated Servers Limited"),
